set_property SRC_FILE_INFO {cfile:C:/Users/wojtp/OneDrive/Pulpit/Studia/fpga-projects-iup/ps2_interface/ps2_interface.srcs/constrs_1/new/constrains.xdc rfile:../../../ps2_interface.srcs/constrs_1/new/constrains.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33   PULLUP TRUE } [get_ports { ps2_clk_i }];  #IO_L13P_T2_MRCC_35 Sch=ps2_clk
set_property src_info {type:XDC file:1 line:6 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33   PULLUP TRUE } [get_ports { ps2_data_i }]; #IO_L10N_T1_AD15N_35 Sch=ps2_data
